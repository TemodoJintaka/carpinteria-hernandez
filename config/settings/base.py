...
MIGRATION_MODULES = {"sites": "madera.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "madera.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ACCOUNT_FORMS = {"signup": "madera.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "madera.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "madera.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
